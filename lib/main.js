    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const file of parsedDiff) {
            ...
            for (const chunk of file.chunks) {
                ...
                const aiResponse = yield getAIResponse(prompt, chunk, file.to);
                console;
                if (aiResponse) {
...
function getAIResponse(prompt, chunk, path) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a, _b;
...
${chunk.changes
        ...
        try {
            ...
            const resultWithLineNumber = result.map((item) => {
                ...
                const position = (_a = articleLines.find(({ text }) => text.includes(originalLine))) === null || _a === void 0 ? void 0 : _a.number;
                if (!position) {
